...
<body>
    <div class="container">
        ...
        <form id="quiz-form" action="upload_quiz.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select id="course_name" name="course_name" required>
                    <option value="Architecture">ARKI</option>
                    <option value="Civil Engineering">CIVIL</option>
                    <option value="Mechanical Engineering">MECHA</option>
                    <option value="Master Plumbing">Master Plumb</option>
                </select>
            </div>
            <div class="form-group">
