        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 program-content">
                    <h1>Mechanical Engineering Review Program</h1>
                    <p>The Mechanical Engineering Review Program is 5 months of review in preparation for the Architecture Licensure Exam. Graduates of Mechanical Engineering are eligible to take the board exam.</p>
                    <a href="#" class="btn btn-primary btn-lg">Enroll Now!</a>
                </div>
                <div class="col-md-6 program-image text-center">
                    <img src="all/images/image2 (4).jpg" alt="Mechanical Engineering" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
