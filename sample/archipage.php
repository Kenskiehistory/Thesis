        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 program-content">
                    <h1>Architecture Review Program</h1>
                    <p>The Architecture Review Program is 5 months of review in preparation for the Architecture Licensure Exam. Graduates of Architecture are eligible to take the board exam.</p>
                    <a href="#" class="btn btn-primary btn-lg">Enroll Now!</a>
                </div>
                <div class="col-md-6 program-image text-center">
                    <img src="all/images/image2 (2).jpg" alt="Architecture" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
