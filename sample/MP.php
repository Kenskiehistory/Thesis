        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 program-content">
                    <h1>Master Plumber Review Program</h1>
                    <p>The Master Plumber Review Program is 4 months of review in preparation for the Master Plumber Licensure Exam. Graduates of Architecture, Mechanical Engineering, Civil Engineering, Chemical Engineering, Mining Engineering, and Electrical Engineering are eligible to take the board exam.</p>
                    <a href="#" class="btn btn-primary btn-lg">Enroll Now!</a>
                </div>
                <div class="col-md-6 program-image text-center">
                    <img src="all/images/image2 (5).jpg" alt="Civil Engineering" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
